/* ============================================================================
 * CAPA 13 · VIEW TRANSITIONS + CURVAS DE RESORTE — app COMERCIOS   ·   02/08/2026
 * ----------------------------------------------------------------------------
 * QUÉ HACE
 ...
 *   sigue corriendo sin efecto visible, y sigue marcando <html class="na-tx">,
...
(function () {
  ...
  var CFG = {
    ORIGENES: ".tool, .ev-card, .linea, .oferta",
    ATRAS:    "#backbtn",
    TX:       "na-tx",
    ZOOM:     false
  };
